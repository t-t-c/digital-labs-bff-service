    ...
    !function (a, b) {
        ...
        function c(a, c) {
            if (c) {
                ...
                var d = a
                        .$check
                        .css(b.transition + "-duration"),
                    f = parseFloat(d);
                b.support.transition && d && f
                    ? this.on(k.transitionEnd, a, e)
                    : a.timer = l.startTimer(a.timer, 50, function () {
                        g(a)
                    }, !0)
            }
        }
        function d(a) {
            l.clearTimer(a.timer, !0),
            this.off(k.namespace)
        }
        function e(b) {
            b.stopPropagation(),
            b.preventDefault();
        ...
        function f(a) {
            a.always || a.$el[j.namespace]("destroy"),
            a
                .callback
                .apply(a.$el)
        }
